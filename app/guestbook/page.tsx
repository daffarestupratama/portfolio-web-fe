...
export default async function GuestbookPage() {
  ...
  return (
    <main className="relative z-[3] mx-auto w-full max-w-[1100px] px-[22px] pt-28 pb-16 sm:pt-32">
      <header className="mb-8">
        ...
        <p className="mt-3 max-w-[52ch] text-[15px]" style={{ lineHeight: 1.6, color: "var(--ink-dim)" }}>
          Say hi, leave feedback, or ask a question. New notes appear here right away.
        </p>
      </header>
